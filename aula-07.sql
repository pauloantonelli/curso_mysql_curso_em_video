...
/*dados ficticios com erros para trabalhar*/
 insert into cursos 
 values
...
/*atualiza o registro da coluna da linha escolhida pelo id*/
update cursos
set nome = 'HTML5'
where idcurso = '1';
/*atualiza o registro da coluna de multiplas linhas escolhidas pelo id*/
update cursos
set nome = 'Java', ano = '2015', carga = '40'
where idcurso = '5'
limit 1;/*limita a modificacao a uma linha! Caso ocorra algum acidente ele so irá modificar uma linha e nao a tabela toda*/
/*deleta a linha do indice da chave primaria*/
delete from cursos
where idcurso = '9';
/*deleta todos os cursos com ano 2050, com limite de remocao de 2 linhas*/
delete from cursos
where ano = '2050'
limit 2;
